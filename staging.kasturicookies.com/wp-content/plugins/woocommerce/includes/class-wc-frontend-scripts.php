		...
		switch ( $handle ) {
			...
			case 'wc-password-strength-meter' :
				return array(
					...
					'i18n_password_hint'    => esc_attr__( 'The password should be at least 7 characters long. To make it stronger, use upper and lower case letters, and numbers.', 'woocommerce' )
				);
			break;
		}
		return false;
